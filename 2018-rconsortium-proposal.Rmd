...
To create this platform, we address our objectives in four parts.
...
[Julie Josse](http://juliejosse.com/) has written R packages for missing data,
include missMDA, and has also authored multiple academic papers on the topic ...
(more details to come)

[Nicholas Tierney](http://www.njtierney.com/) has written two R packages that 
...
Work and steps can be published in blogs on the R Consortium blog.
...
The following table details the cost items.
  ...
  Meeting with partners                                      Euro 1500
  online materials (such as video)                           Euro 1500
  Total                                                      10000

### Emplying a research assistant
