...
- Write documentation/tutorials to better reproduce the
...
values. Some tutorials will be done with small videos. For this to occur, Nick 
and Julie would ideally meet face to face.
...
### Milestone four: future extensions and beyond $20K

4. (M11-M12). Organize data benchmark repository.

We would also like to consider investing more time in establishing peer review practices for missing data packages. To this end, we would be able to hire a part time 
research software engineer to assist with an "editing" role.
